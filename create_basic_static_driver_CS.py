...
def tif_to_array(input_file):
    ...
    for i in range(len(band_array)):
        array.append(band_array[len(band_array) - (i + 1)])
...
class StaticDriver:
    ...
    def __init__(self):
        ...
        """
        print('Opening file...')
        self.nc_file = Dataset('example_static_file_v2.nc', 'w', format='NETCDF4')
    ...
    def define_variables(self):
        ...
        lu_lc = tif_to_array('C:/Users/luis.santos/Desktop/final_image/LULC.tif')

        pavement_type = tif_to_array('C:/Users/luis.santos/Desktop/final_image/LULC.tif')
        pavement_type[pavement_type != 2] = 0
        pavement_type[pavement_type == 2] = 1

        soil_type = tif_to_array('C:/Users/luis.santos/Desktop/final_image/LULC.tif')
        soil_type[soil_type > 10] = -127
        soil_type[soil_type <= 10] = 2 # medium

        vegetation_type = tif_to_array('C:/Users/luis.santos/Desktop/final_image/LULC.tif')
        vegetation_type[(vegetation_type > 10) | (vegetation_type < 3)] = 0
        vegetation_type[(vegetation_type == 4) | (vegetation_type == 6)] = 6
        vegetation_type[(vegetation_type >= 8) & (vegetation_type <= 10)] = 14
        vegetation_type[vegetation_type == 3] = 1
        vegetation_type[vegetation_type == 5] = 8
        vegetation_type[vegetation_type == 7] = 3

        water_type = tif_to_array('C:/Users/luis.santos/Desktop/final_image/LULC.tif')
        water_type[water_type < 11] = 0
        water_type[water_type == 11] = 2
        water_type[water_type == 12] = 1
        water_type[water_type == 13] = 3
        ...
        nc_building_id[:,:] = tif_to_array('C:/Users/luis.santos/Desktop/final_image/build_id.tif')
        ...
        # nc_buildings_2d.units = "1"
        # nc_buildings_2d[:, :] = nc_buildings_2d._FillValue
        nc_buildings_2d[:, :] = tif_to_array('C:/Users/luis.santos/Desktop/final_image/building_height.tif')
        ...
        nc_building_type[:, :] = tif_to_array('C:/Users/luis.santos/Desktop/final_image/Build_type.tif')
        ...
        nc_pavement_type[:, :] = pavement_type
        ...
        nc_vegetation_type[:, :] = vegetation_type
        ...
        #     # nc_building_id[:, :] > nc_building_id._FillValue,
        #     nc_building_id[:, :] > nc_building_id,
        #     nc_building_id[:, :] * 10.0,
        #     nc_buildings_2d[:, :])
        # nc_buildings_2d = tif_to_array('C:/Users/luis.santos/Desktop/final_image/build_id.tif')
        ...
        #     nc_building_id[:, :] * 1,
        #     nc_building_type[:, :])
        # nc_building_type[:,:] = np.where(nc_building_id[:, :] > nc_building_id._FillValue, \
        #         tif_to_array('C:/Users/luis.santos/Desktop/final_image/Build_type.tif'), \
        #         nc_building_type[:, :])
        ...
        # Set vegetation
        # --------------
        lad_profile = [0.0, 0.01070122, 0.1070122, 0.3130108, 0.3879193, 0.1712195]  # TODO adapt for a georef. input
